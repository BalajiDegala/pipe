import pipe.pipenodes.qss.nodeeditor_dark_resources
import os
...
from pipe.pipenodes.pipe_sub_window import CalculatorSubWindow
from pipe.pipenodes.pipe_drag_listbox import QDMDragListbox
from nodeeditor.utils import dumpException, pp
from pipe.pipenodes.pipe_conf import CALC_NODES
...
class CalculatorWindow(NodeEditorWindow):
    ...
    def initUI(self):
        self.name_company = 'PIPE' # REPLACE WITH YOUR COMPANY
        self.name_product = 'PIPE'
    ...
    def onFileOpen(self):
        fnames, filter = QFileDialog.getOpenFileNames(
            self, 'Open graph from file', "~/", self.getFileDialogFilter())
    ...
    def about(self):
        QMessageBox.about(self, "Digital Domain India",
                          "Nodal Documentation of workflow at DIGITAL DOMAIN"
                          "\nDDHB Pipeline "
                          )
