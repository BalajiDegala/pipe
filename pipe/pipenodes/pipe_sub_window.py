...
from pipe.pipenodes.pipe_conf import CALC_NODES, get_class_from_opcode, LISTBOX_MIMETYPE
...
class CalculatorSubWindow(NodeEditorWidget):
    ...
    def handleNodeContextMenu(self, event):
        context_menu = QMenu(self)
        markDirtyAct = context_menu.addAction("D A T A")
        markDirtyDescendantsAct = context_menu.addAction("E N T I T Y")
        markInvalidAct = context_menu.addAction("D E P T")
        unmarkInvalidAct = context_menu.addAction("T I T L E")
        evalAct = context_menu.addAction("I M A G E")
